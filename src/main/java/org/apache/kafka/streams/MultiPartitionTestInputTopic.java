...
/**
 * {@code MultiPartitionTestInputTopic} is used to pipe records to topic in {@link MultiPartitionTopologyTestDriver}.
 * To use {@code MultiPartitionTestInputTopic} create a new instance via
 * {@link MultiPartitionTopologyTestDriver#createInputTopic(String, Serializer, Serializer)}.
 * In actual test code, you can pipe new record values, keys and values or list of {@link KeyValue} pairs.
 * If you have multiple source topics, you need to create a {@code MultiPartitionTestInputTopic} for each.
 *
 * <h2>Processing messages</h2>
 * <pre>{@code
 *     private MultiPartitionTestInputTopic<Long, String> inputTopic;
 *     ...
 ...
 * @see MultiPartitionTopologyTestDriver
 */

public class MultiPartitionTestInputTopic<K, V> {
    private final MultiPartitionTopologyTestDriver driver;
    ...
    MultiPartitionTestInputTopic(final MultiPartitionTopologyTestDriver driver,
                   final String topicName,
                   final Serializer<K> keySerializer,
                   final Serializer<V> valueSerializer,
                   final Instant startTimestamp,
                   final Duration autoAdvance) {
        Objects.requireNonNull(driver, "MultiPartitionTopologyTestDriver cannot be null");
     ...
     * {@link MultiPartitionTopologyTestDriver} as long as no new input records are piped.
     * Furthermore, it does not advance the wall-clock time of {@link MultiPartitionTopologyTestDriver}.
     *
     ...
     * {@link #MultiPartitionTestInputTopic(MultiPartitionTopologyTestDriver, String, Serializer, Serializer, Instant, Duration) autoAdvance} setting.
     *
    ...
    public String toString() {
        return new StringJoiner(", ", MultiPartitionTestInputTopic.class.getSimpleName() + "[", "]")
                .add("topic='" + topic + "'")
