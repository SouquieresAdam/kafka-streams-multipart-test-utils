...
/**
 * {@code MultiPartitionTestOutputTopic} is used to read records from a topic in {@link MultiPartitionTopologyTestDriver}.
 * To use {@code MultiPartitionTestOutputTopic} create a new instance via
 * {@link MultiPartitionTopologyTestDriver#createOutputTopic(String, Deserializer, Deserializer)}.
 * In actual test code, you can read record values, keys, {@link KeyValue} or {@link TestRecord}
 * If you have multiple source topics, you need to create a {@code MultiPartitionTestOutputTopic} for each.
 * <p>
 ...
 * <pre>{@code
 *     private MultiPartitionTestOutputTopic<String, Long> outputTopic;
 *      ...
 ...
 */
public class MultiPartitionTestOutputTopic<K, V> {
    private final MultiPartitionTopologyTestDriver driver;
    private final String topic;
    private final Deserializer<K> keyDeserializer;
    private final Deserializer<V> valueDeserializer;

    MultiPartitionTestOutputTopic(final MultiPartitionTopologyTestDriver driver,
    ...
    public String toString() {
        return new StringJoiner(", ", MultiPartitionTestOutputTopic.class.getSimpleName() + "[", "]")
                .add("topic='" + topic + "'")
